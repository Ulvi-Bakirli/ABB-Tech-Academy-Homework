...
import Model.NonAbstarcts.Man;
import Model.NonAbstarcts.Woman;
...
public class Menu {
    ...
    public void showMenu() {
        ...
        while (result) {
            ...
            switch (menuNumber) {
                case "1":
                    Woman woman1 = new Woman("Leyla", "Quliyeva", "17/12/2001", 90,
                            Map.of(DayOfWeek.MONDAY, "Reading book", DayOfWeek.SUNDAY, "Watching film"));
                    Man man1 = new Man("Ali", "Quliyev", "01/05/1971", 70,
                            Map.of(DayOfWeek.FRIDAY, "Reading book", DayOfWeek.SUNDAY, "Watching film"));
                    familyController.createNewFamily(woman1, man1);


                    Woman woman2 = new Woman("Leyla", "Quliyeva", "17/12/2001", 90,
                            Map.of(DayOfWeek.MONDAY, "Reading book", DayOfWeek.SUNDAY, "Watching film"));
                    Man man2 = new Man("Ali", "Quliyev", "01/05/1971", 70,
                            Map.of(DayOfWeek.FRIDAY, "Reading book", DayOfWeek.SUNDAY, "Watching film"));
                    ...
                    Woman woman3 = new Woman("Leyla", "Quliyeva", "17/12/2001", 90,
                            Map.of(DayOfWeek.MONDAY, "Reading book", DayOfWeek.SUNDAY, "Watching film"));
                    Man man3 = new Man("Ali", "Quliyev", "01/05/1971", 70,
                            Map.of(DayOfWeek.FRIDAY, "Reading book", DayOfWeek.SUNDAY, "Watching film"));
