...
public class Human {
    ...
    public Human(String name, String surname, Integer year, Family family) {
        this.name = name;
    ...
    public Human(String name, String surname, Integer year, Integer iq, Map<String, String> schedule, Family family) {
        this.name = name;
        this.surname = surname;
        this.year = year;
        this.iq = iq;
